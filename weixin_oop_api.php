<?php
 //1、接受微信服务器传的四个参数
// define("TONKEN","zhaopeng");//定义tonken
//$wx = new weixinApi();
//$wx->valid();
session_start();
 class weixinApi{
 	
	private $appid = "wxd4218bd4c85ec1fa";
	private $appsecret = "990d7a3e2d9ecc91e2449df17eaeb679";		 
		...
		private function checkSignature(){  // 验证微信签名的函数
  ...
  public function https_request($url,$data=null){
	...
	public function snsapi_base($hd_url){
	...
	public function snsapi_userinfo($hd_url){
